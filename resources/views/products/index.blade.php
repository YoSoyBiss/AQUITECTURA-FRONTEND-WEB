...
<head>
    ...
    <style>
        ...
        .modal-content {
            ...
            padding: 20px; width: 400px; border-radius: 8px;
            text-align: center;
        }
        .modal-buttons { margin-top: 20px; }
        .modal-buttons button {
            padding: 10px 20px; margin: 0 10px; border: none;
            border-radius: 5px; font-weight: bold; cursor: pointer;
        }
        .btn-cancel { background-color: #ccc; }
        .btn-confirm { background-color: #c62828; color: white; }
    </style>
</head>
<body>
<div class="container">
...
<script>
    ...
    function deleteProduct() {
        ...
        // Update form action to target the destroy route
        const form = document.getElementById('deleteForm');
        form.action = `/products/${selectedId}`;
        form.submit(); // Send request via Laravel route
